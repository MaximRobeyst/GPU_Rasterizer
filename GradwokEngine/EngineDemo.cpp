...
void EngineDemo::Start()
{
	...
	m_pButton = new Button(L"Click here");
	m_pButton->SetBounds(20, 20, 100, 100);
...
void EngineDemo::Paint(RECT rect)
{
	...
	GAME_ENGINE->DrawLine(20, 20, GAME_ENGINE->GetWidth() - 20, GAME_ENGINE->GetHeight() - 20);
}
...
void EngineDemo::CallAction(Caller* callerPtr)
{
	...
	{
		GAME_ENGINE->MessageBox(L"Clicked");
	}
}
